            ...
            <div class="row mt-5">
                <div class="col-md-8">
                    <div class="lichny-schet-emitent">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="lichny-schet-vyplata">
                                    <div class="row">
                                        <div class="col-6 mt-2">Поступило:</div>
                                        <div class="col-6 mt-2 text-right">Выплачено:</div>
                                        <div class="col-6 d-flex justify-content-between mt-3"><span class="lichny-schet-purpur font-weight-bold">23 814,00 Р</span><span class="lichny-schet-vyplata-small">из 40 814,00 Р</span></div>
                                        <div class="col-6 d-flex justify-content-between mt-3"><span class="lichny-schet-vyplata-small">из 13 450,00 Р</span><span class="lichny-schet-orange font-weight-bold">9 814,00 Р</span></div>
                                    </div>
                                </div>
                                <div class="progress lichny-schet-progress-viplacheno">
                                    <div class="lichny-schet-progress-half">
                                        <div class="lichny-schet-bg-purpur" style="width: 45%"></div>
                                    </div>
                                    <div class="lichny-schet-progress-half">
                                        <div class="lichny-schet-bg-orange" style="width: 35%"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="lichny-schet-sum-post">
                                    <div class="row">
                                        <div class="col-6">
                                            <span class="d-block">Сумма ближайшего платежа:</span>
                                            <span class="d-block gray_text">23.11.2018</span>
                                            <span class="d-block lichny-schet-sum-post-price lichny-schet-orange">13 450,<span>00</span> P</span>
                                        ...
                                        <div class="col-6">
                                            <span class="d-block">Сумма ближайшего платежа:</span>
                                            <span class="d-block gray_text">23.11.2018</span>
                                            <span class="d-block lichny-schet-sum-post-price lichny-schet-red">13 450,<span>00</span> P</span>
                                            <div class="progress lichny-schet-progress-ostatok">
                        ...
                        <button class="btn btn-light btn-standart mt-5">График выплат</button>
                    </div>
                </div>
                <div class="col-md-4">
